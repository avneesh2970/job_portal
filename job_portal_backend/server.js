...
app.use(cors({
  origin: ['https://job-portal-0dok.onrender.com','https://api.nnhire.novanectar.co.in', 'http://localhost:5173','http://localhost:5174','http://localhost:5175'], // ⬅️ array of URLs
  credentials: true,
