                ...
                applications.map((app, index) => (
                  <tr key={index}>
                    ...
                    <td className="font-medium text-sm    flex justify-start items-center my-auto m-auto">
                      <span
                        className={`px-3 -mt-14 py-2 my-auto flex justify-center items-center rounded-full text-sm font-semibold  transition-all duration-200
    ${app.status === "Submitted"
                      ...
                      >
                        {app.statusHistory?.length > 0 && (
                          <span>
                            {app.statusHistory[app.statusHistory.length - 1].value}
                          </span>
                        )}
                      </span>
                    </td>
